...
| Default category | Platform Governance / Audit & Compliance |
| Primary focus | audit evidence, sensitive actions, accountability |
...
- Required plugins: `auth-core`, `org-tenant-core`
- Recommended plugins: none
